        ...
        <div class="slider-wrapper">
            ...
            <div class="slide" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('assets/img/bg/slider2.jpeg')">
                <div class="slide-content">
                    ...
                    <p>Explore the world's tallest statue, a tribute to Sardar Vallabhbhai Patel, standing tall as a symbol of India's unity.</p>
                </div>
            </div>
...
<section class="section">
    ...
    <div class="cards">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="destinations.php?city_id=' . $row['city_id'] . '" class="btn" style="padding: 8px 20px;">Explore</a>';
            echo '</div>';
        }
        ?>
    </div>
...
<section class="section">
    ...
    <div class="cards">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="card glass">';
            echo '<img src="assets/images/packages/' . $row['image_url'] . '" alt="' . $row['name'] . '">';
            echo '<h3>' . $row['name'] . '</h3>';
            ...
            if (isset($_SESSION['loggedin'])) {
                ...
                echo '<a href="login.php" class="btn" style="padding: 8px 20px; margin-top: 10px;">Login to Book</a>';
            }
...
<section class="section">
    ...
    <div class="cards">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="card glass" style="text-align: left;">';
            echo '<div style="display: flex; align-items: center; margin-bottom: 15px;">';
            echo '<div style="width: 50px; height: 50px; background: #35ffeeff; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; color: white; font-weight: bold;">';
