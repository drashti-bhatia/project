...
<head>
    ...
    <style>
        ...
        .package-content p {
            ...
            color: #555;
            line-height: 1.6;
            /* This pushes the content below it down, ensuring the button is always at the bottom */
            flex-grow: 1;
        }
            ...
            <?php if ($result && mysqli_num_rows($result) > 0): ?>
                <?php while ($package = mysqli_fetch_assoc($result)): ?>
                    <div class="package-card">
                        <img src="assets/img/packages/<?php echo htmlspecialchars($package['image_url']); ?>"
